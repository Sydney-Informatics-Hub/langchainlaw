...
The batch_records spreadsheet keeps track of batch requests. All three ```classifier.batch_send```, ```classifier.batch_check``` and ```classifier.batch_get``` use and update this spreadsheet.
